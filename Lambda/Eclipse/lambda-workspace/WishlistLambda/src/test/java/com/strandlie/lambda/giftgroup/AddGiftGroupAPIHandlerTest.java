 ...
 */
public class AddGiftGroupAPIHandlerTest {

    private static GiftGroupRequest addGiftGroupRequest;
    ...
    public static void createInput() throws IOException {
    	addGiftGroupRequest = new GiftGroupRequest();
    	addGiftGroupRequest.setName("Christmas 2018");
    }

    private Context createContext() {
        TestContext ctx = new TestContext();

        ctx.setFunctionName("addGiftGroup");
    ...
    @Test
    public void testAddGiftGroupAPIHandler() {
        AddGiftGroupAPIHandler handler = new AddGiftGroupAPIHandler();
        Context ctx = createContext();

        GiftGroupResponse output = (GiftGroupResponse) handler.handleRequest(addGiftGroupRequest, ctx);
        
        Assert.assertTrue(output.getGiftGroupIsAdded());
    }
}
